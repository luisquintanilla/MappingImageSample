...
namespace MappingImageSampleML.Model
{
    ...
    {
        public static string[] Label { get; set; } = new string[] { "AnnualCrop", "Forest", "HerbaceousVegetation", "Highway", "Industrial", "Pasture", "PermanentCrop", "Residential", "River", "SeaLake", };
